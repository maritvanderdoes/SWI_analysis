...
2. Quality check.
3. Compress the data using the <code>StkToTifImageCompressionWorkflow</code> workflow from <a href= vcl1048.fmi.ch/frontend/jobs><code>vcl1048.fmi.ch/frontend/jobs/</code></a>.
