...
# Computing tools
from utils import adaptive_masking, make_mask_background 
from utils import calculate_worm_properties, crop_image
# Benchmarking
...
def main_function(list_mcherry,list_GFP):
    with timeout(time_out):
        ...
        try:
            ...
            (mean_background,_)= calculate_worm_properties(background_binary, img_gfp) 
