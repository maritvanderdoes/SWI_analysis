...
2. Quality check.
3. Compress the data using the <code>StkToTifImageCompressionWorkflow</code> workflow from <code><html><a href= www.vcl1048.fmi.ch/frontend/jobs>vcl1048.fmi.ch/frontend/jobs/</a></html></code>.
