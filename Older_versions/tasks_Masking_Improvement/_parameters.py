...
Lucas_path = '//tungsten-nas.fmi.ch/tungsten/scratch/ggrossha/Marit/HetP_Quant/20201224_HBL1'
...
# Create straightened worm folder
straightenedname = outputpath+'/Straightened'
# Creating the individual debugging folder
if not os.path.exists(straightenedname):
    print('MAIN: Creating debugging folder.')
    os.makedirs(straightenedname)
