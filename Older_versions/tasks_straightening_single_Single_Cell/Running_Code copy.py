...
outputpath = 'C:/Users/moraluca/Desktop/Lin28_test/Output_2'
...
kpoints = np.arange(100,150)
plt.plot(img_mcherry[12,::5,::5].flatten(),img_gfp[12,::5,::5].flatten(),'.')
plt.plot(5*kpoints-300,kpoints)

#%%
plt.hist(img_mcherry[12,::5,::5].flatten()-img_gfp[12,::5,::5].flatten(),50)
...
# %%
pl_sel = 12
plt.imshow((img_mcherry[pl_sel,:,:]-10*img_gfp[pl_sel,:,:])>100)
plt.figure()
plt.imshow(img_mcherry[pl_sel,:,:])
plt.figure()
plt.imshow(img_gfp[pl_sel,:,:])

#%% Checking different thresholds
n_pt = 21
mm_th_vec = np.linspace(1.06, 1.6, n_pt)
