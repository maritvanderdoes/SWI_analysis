...
result_file['norm_data'] = result_file['mean_curved'] - result_file['median_curved']
result_file['norm_data'] = result_file['mean_curved'] - result_file['mean_bg']
# result_file['norm_data'] = (result_file['mean_curved'] - result_file['median_curved'])/result_file['mean_curved']
...
plt.figure()
plt.plot(result_file[result_file['Type']==0]['median_curved'],result_file[result_file['Type']==0]['mean_curved'],'x')
plt.grid()

plt.figure()
plt.plot(result_file[result_file['Type']==1]['median_curved'],result_file[result_file['Type']==1]['mean_curved'],'o')
plt.grid()
...
for k_tp, tp_sel in enumerate(time_vals[0:n_tps]):
    ...
    X = np.array([result_sel['max_surr'],result_sel['Type']])
    # X = np.array([result_sel['mean_bg'],result_sel['Type']])
    X = np.transpose(X)
    X = sm.add_constant(X)
    # Y = result_sel['mean_curved']
    Y = result_sel['mean_mip']
...
for sp_sel in np.arange(40,42,1):
    ...
    plt.xlabel('Time')
# %%
sns.lineplot(data=result_file, x = 'Hours', y = 'signal_bg_removed', hue = 'Position')
# %%
